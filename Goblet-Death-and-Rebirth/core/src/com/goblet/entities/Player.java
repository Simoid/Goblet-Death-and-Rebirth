...
public class Player extends Entity{
    ...
    public Player(int xPos, int yPos, float moveSpeed){
        ...
        attackAnimations.put(Direction.UP, new SpriteAnimation(spriteLocation + "mc/mc_attack_up.pack",4,1/18f, false));
        attackAnimations.put(Direction.DOWN, new SpriteAnimation(spriteLocation + "mc/mc_attack_down.pack",4,1/18f, false));
